...
import './styles.css'
const ImportTeasyJsonAndBackup: React.FC = (props: any) => {
    const history = useHistory();
    const [teasyJson, setTeasyJson] = useState("");
    const [treeBackUp, setTreeBackUp] = useState("");
    ...
    function goToMountTree() {
        if (checkField()) {
            ...
            history.push(
                "/mount-tree",
                { teasyJson, treeBackUp }
            );
        }
    }

    function checkField() {
        return teasyJson.trim() === "" || treeBackUp.trim() === "";
    }
        ...
        <div className="home-container">
            ...
            <div className="content-center">
                ...
                <div className="right">
                    ...
                    <textarea
                        name="textarea"
                        onChange={e => setTreeBackUp(e.target.value)}
                    >
                    </textarea>
                </div>
            </div>
            ...
            <div className="letsbtn">
                <button type="button" className="letsgo" onClick={goToMountTree}>Let's Go!</button>
            </div>
...
export default ImportTeasyJsonAndBackup;
